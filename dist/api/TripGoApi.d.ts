...
declare class TripGoApi {
    ...
    static apiCall(endpoint: string, method: string, body?: any, cache?: boolean): Promise<any>;
    static apiCallT<T>(endpoint: string, method: string, resultClassRef: {
        new (): T;
    }, body?: any): Promise<T>;
    static getSatappUrl(endpoint: string): string;
    static apiCallUrl(url: string, method: string, body?: any, cache?: boolean): Promise<any>;
