...
export declare type TKUIConfig = ITKUIConfigRequired & Partial<ITKUIConfigOptional>;
...
export declare type TKComponentConfig<P extends TKUIWithClasses<S, P>, S> = Partial<Subtract<TKComponentDefaultConfig<P, S>, {
    styles: TKUIStyles<S, P>;
}> & {
    styles: TKUICustomStyles<S, P>;
}>;
declare type TKUIPropsOverride<P extends TKUIWithClasses<S, P>, S> = Partial<P> | ((implProps: P) => Partial<P>);
export {};
