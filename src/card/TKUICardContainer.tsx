...
// order in which cards requested being displayed. Also considers the open property, and when set to false it removes
// from the map and list, which means it will stop showing the card. Using open = false as not rendered is ok since
// TKUICard currently handles it that way.
