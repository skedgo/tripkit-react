                ...
                .reduce((overrideStylesMerge: Partial<CustomStyles<keyof ST, PR>>, className: string) => {
                    const classOverride = defaultStyle => {
                        ...
                        const cssPropsOverridden1: CSSProps<PR> = Util.isFunction(cssPropsOverride1) ?
                            ...
                            (cssPropsOverride1 as CSSProps<PR>) ?? defaultStyle;   // If no class for className (cssPropsOverride1 === undefined), then retain defaultStyle.
                        ...
                        const cssPropsOverridden2: CSSProps<PR> = Util.isFunction(cssPropsOverride2) ?
                            ...
                            (cssPropsOverride2 as CSSProps<PR>) ?? cssPropsOverridden1;    // If no class for className (cssPropsOverride2 === undefined), then retain cssPropsOverriden1.
